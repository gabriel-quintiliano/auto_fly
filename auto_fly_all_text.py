...
def _create_custom_dict(file, separator) -> dict:
    ...
    while (line := file.readline()):
        ...
        # aqui eu não uso o os_linesep pois como estamos lendo o arquivo como texto diretamente,
        # Python traduz qualquer linesep que o sistema tenha usado no arquivo para o '\n' seja
        # '\r' ou '\r\n'.
        while line[i] != separator and line[i:i+linesep_len] != '\n':
            i += 1
        
        if line[i:i+linesep_len] != '\n':
            key = line[:i]
